...
const RevenueAllHotelsMonthly = ({ from, to }) => {
    ...
    const fetchData = async () => {
        ...
        setLoading(true);
        try {
            const res = await api.get("/chu-khach-san/thong-ke/doanh-thu/all/monthly", {
                params: { from, to },
            });
            ...
            console.error("Lỗi khi lấy doanh thu tất cả khách sạn theo tháng:", err);
        } finally {
            setLoading(false);
        }
    };
...
export default RevenueAllHotelsMonthly;
