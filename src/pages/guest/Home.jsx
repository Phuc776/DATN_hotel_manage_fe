...
export default function Home() {
  ...
  return (
    <div className="space-y-12">
      <section className="bg-linear-to-r from-blue-500 to-indigo-600 text-white py-16 rounded-lg">
        <div className="max-w-2xl px-6">
          ...
          {/* <div
            ...
            className="bg-white text-blue-600 font-semibold px-6 py-3 rounded-lg hover:bg-gray-100 transition cursor-pointer inline-block"
          >
            Đăng Nhập Ngay
          </div> */}
        </div>
      ...
      <section className="bg-white p-6 rounded-lg">
        <h2 className="text-2xl font-bold mb-4">Bài đăng phòng</h2>
        {posts.length === 0 ? (
            ...
            {posts.map((p) => (
              <Col key={p.id} xs={24} sm={12} lg={8}>
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm mb-2">Giá: {p.loaiPhong.gia?.toLocaleString() || "—"} VNĐ / đêm</p>
                  <div className="flex items-center justify-between">
                    <Button type="link">
